...
func check_for_match_within_secondary_field(users_guess string) bool {
	// Look for a partial match within the secondary meaning field
	fields_from_aCard := []string{aCard.Second_Meaning}
...
func check_for_match_in_other_fields(users_guess string) bool {
	// Look for a partial match within the auxiliary fields
	fields_from_aCard := []string{aCard.Kunyomi, aCard.Onyomi, aCard.Vocab, aCard.Vocab2}
